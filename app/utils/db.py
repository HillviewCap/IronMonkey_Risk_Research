print("Importing app/utils/db.py...")
import os
import psycopg2
...
def get_db_connection():
    ...
    if _connection_pool is None:
        try:
            ...
            print(
                "Connecting to DB using individual parameters (DATABASE_URL block commented out):"
            )
            ...
            # if db_url: # Commenting out DATABASE_URL block
            #     print("Connecting to DB using DATABASE_URL:", db_url)
